...
def user_input():
    ...
    if user_name:
        ...
        with st.form(key='team_selection'):
            ...
            qb = st.multiselect('Select 1 QB:', qb_choices['Player_Team'].tolist(), max_selections=1)
            selected_players = [{'Player': player, 'Position': 'QB',
                                 'Team': qb_choices[qb_choices['Player_Team'] == player]['Team'].values[0]} for player in qb]
            ...
            rbs = st.multiselect('Select 2 RBs:', rb_choices['Player_Team'].tolist(), max_selections=2)
            selected_players += [{'Player': player, 'Position': 'RB',
                                  'Team': rb_choices[rb_choices['Player_Team'] == player]['Team'].values[0]} for player in
                                 rbs]
            ...
            wrs = st.multiselect('Select 2 WRs:', wr_choices['Player_Team'].tolist(), max_selections=2)
            selected_players += [{'Player': player, 'Position': 'WR',
                                  'Team': wr_choices[wr_choices['Player_Team'] == player]['Team'].values[0]} for player in
                                 wrs]
            ...
            te = st.multiselect('Select 1 TE:', te_choices['Player_Team'].tolist(), max_selections=1)
            selected_players += [{'Player': player, 'Position': 'TE',
                                  'Team': te_choices[te_choices['Player_Team'] == player]['Team'].values[0]} for player in
                                 te]
            ...
            flex = st.multiselect('Select 1 additional player from RB/WR/TE:', flex_choices['Player_Team'].tolist(),
                                  max_selections=1)
            selected_players += [
                {'Player': player, 'Position': flex_choices[flex_choices['Player_Team'] == player]['Position'].values[0],
                 'Team': flex_choices[flex_choices['Player_Team'] == player]['Team'].values[0]} for player in flex]
